...
public class proyector extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_proyector);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.proyector, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_televisor) {
            ...
            Intent intent = new Intent(proyector.this, televisor.class);
            startActivity(intent);

        } else if (id == R.id.nav_luces) {

            Intent intent = new Intent(proyector.this, luces.class);
            startActivity(intent);
